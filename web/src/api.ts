 ...
 *
 * Правится она пока только сервером, и в студии её видно, но не
 * переписать. Показывать при этом обязательно: правило с проверкой и
 * правило без неё держатся по-разному — первое обязательно к исполнению,
 * второе зависит от сговорчивости модели, — и различие это составитель
 * должен видеть, решая, чинить задачу или правило.
 */
