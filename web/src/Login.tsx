        ...
        <div className="stack">
          ...
          <div>
            ...
            <input
              ...
              name="login"
              value={login}
              // Правило разборщика здесь отключено осознанно, а не
              // обойдено: оно бережёт от курсора, уведённого куда-то
              // посреди большой страницы. Здесь страница — одно это поле
              // и одно следующее, и ставить курсор руками пришлось бы
              // каждому входящему, включая того, кто работает с клавиатуры.
